...
- 🔗 🌐 **[`sender.html`](https://glowinthedark.github.io/multi-qr-air-gapped-file-transfer/sender.html)** — runs in a browser on the device that has the file. Encodes it into a stream of QR codes and displays them on a loop.
